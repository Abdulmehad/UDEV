...
const validateInputLengths = (username, email) => {
  const errors = [];
  if (username && username.length > MAX_LENGTH_NAME) {
...
const handleValidationErrors = (req, res, next) => {
  ...
  const lengthErrors = validateInputLengths(username, email);
